...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Gold Eman
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Graphics Designer</h3>
        <p className="home__description">I'm a creative designer based
        in California, and I'm very passionate and dedicated to my work.
        </p>

        <a style={{
          background: 'linear-gradient(90deg, rgb(14, 94, 241) 0%, rgba(206,3,184,1) 100%, rgba(0,212,255,1) 100%)',}} href="#contact" className="button button--flex" 
          >
